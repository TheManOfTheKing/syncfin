...
export default function Documentacao() {
  ...
  const [selectedSection, setSelectedSection] = useState<string | null>('introducao');
      ...
      content: (
        <div className="space-y-4">
          <p className="text-slate-300 leading-relaxed">
            ...
            reconciliação de extratos bancários, classificando transações automaticamente, detectando transferências 
            internas e realizando conciliação bancária completa comparando movimentações bancárias com lançamentos contábeis do ERP.
          </p>
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-slate-300">
              ...
              <li>Conciliação bancária completa (banco vs. contábil)</li>
              <li>Importação de lançamentos contábeis do ERP</li>
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          title: 'Conciliação Bancária Completa',
          category: 'guia',
          content: (
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-white mb-4">🔄 Conciliação Banco vs. Contábil</h3>
              
              <div className="bg-indigo-500/10 border border-indigo-500/30 rounded-lg p-4 mb-4">
                <h4 className="text-indigo-400 font-semibold mb-2">O que é Conciliação Bancária?</h4>
                <p className="text-slate-300 text-sm">
                  A conciliação bancária compara as movimentações do extrato bancário com os lançamentos contábeis 
                  do seu ERP (contas a pagar e receber), identificando quais contas foram pagas/recebidas e detectando 
                  divergências e valores não previstos.
                </p>
              </div>

              <div className="space-y-4">
                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                  <h4 className="text-white font-semibold mb-3">Passo 1: Importar Lançamentos Contábeis</h4>
                  <p className="text-slate-300 text-sm mb-2">
                    Na aba <strong className="text-white">"Importar Lançamentos"</strong> da página de Conciliação:
                  </p>
                  <ol className="list-decimal list-inside text-slate-300 text-sm space-y-1 ml-2">
                    <li>Selecione a empresa</li>
                    <li>Selecione a conta bancária (opcional)</li>
                    <li>Faça upload do arquivo com lançamentos do ERP</li>
                    <li>Formatos aceitos: CNAB 240, CNAB 400 ou CSV</li>
                  </ol>
                  <p className="text-slate-300 text-sm mt-3">
                    <strong className="text-white">Formato CSV:</strong> Deve conter colunas como tipo (pagar/receber), 
                    data_vencimento, descrição, valor, número_documento, fornecedor/cliente, etc.
                  </p>
                </div>

                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                  <h4 className="text-white font-semibold mb-3">Passo 2: Executar Conciliação</h4>
                  <p className="text-slate-300 text-sm mb-2">
                    Na aba <strong className="text-white">"Executar Conciliação"</strong>:
                  </p>
                  <ol className="list-decimal list-inside text-slate-300 text-sm space-y-1 ml-2">
                    <li>Selecione a empresa</li>
                    <li>Selecione a conta bancária (ou deixe em branco para todas)</li>
                    <li>Defina o período (data início e data fim)</li>
                    <li>Clique em "Executar Conciliação"</li>
                  </ol>
                  <p className="text-slate-300 text-sm mt-3">
                    O sistema comparará automaticamente cada transação bancária com os lançamentos contábeis, 
                    identificando matches com diferentes níveis de confiança.
                  </p>
                </div>

                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                  <h4 className="text-white font-semibold mb-3">Passo 3: Revisar Matches Sugeridos</h4>
                  <p className="text-slate-300 text-sm mb-2">
                    Na aba <strong className="text-white">"Resultados"</strong>, clique em "Ver Detalhes" do lote:
                  </p>
                  <ul className="list-disc list-inside text-slate-300 text-sm space-y-1 ml-4">
                    <li><strong className="text-white">Matches Automáticos (≥85%):</strong> Já estão aprovados automaticamente</li>
                    <li><strong className="text-white">Matches Sugeridos (60-84%):</strong> Requerem sua aprovação ou rejeição</li>
                    <li><strong className="text-white">Divergências:</strong> Transações sem correspondência ou com problemas</li>
                  </ul>
                  <p className="text-slate-300 text-sm mt-3">
                    Para cada match sugerido, você pode:
                  </p>
                  <ul className="list-disc list-inside text-slate-300 text-sm space-y-1 ml-4">
                    <li><strong className="text-white">Aprovar:</strong> Confirma a correspondência</li>
                    <li><strong className="text-white">Rejeitar:</strong> Informe o motivo da rejeição</li>
                  </ul>
                </div>

                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                  <h4 className="text-white font-semibold mb-3">Passo 4: Exportar Resultados</h4>
                  <p className="text-slate-300 text-sm mb-2">
                    Após revisar e aprovar os matches, exporte o resultado:
                  </p>
                  <ol className="list-decimal list-inside text-slate-300 text-sm space-y-1 ml-2">
                    <li>Na aba "Resultados", clique em "Exportar" no lote desejado</li>
                    <li>Escolha o formato: CSV, CNAB 240, CNAB 400, JSON ou Relatório TXT</li>
                    <li>O arquivo será baixado automaticamente</li>
                    <li>Importe o arquivo no seu ERP para dar baixa automática nos títulos conciliados</li>
                  </ol>
                </div>
              </div>

              <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/30 rounded-lg p-4 mt-6">
                <h4 className="text-indigo-400 font-semibold mb-2">💡 Dica Importante</h4>
                <p className="text-slate-300 text-sm">
                  O sistema utiliza um motor de matching em 3 fases: primeiro busca por identificadores únicos 
                  (nosso número, código de barras), depois por valor exato + data próxima, e por fim por similaridade 
                  de descrição. Quanto mais informações você tiver nos lançamentos (números de documento, nosso número, etc.), 
                  melhor será a precisão da conciliação.
                </p>
              </div>
            </div>
          ),
          ...
          content: (
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                  <h4 className="text-white font-semibold mb-2">Quais formatos de lançamentos contábeis são aceitos?</h4>
                  <p className="text-slate-300 text-sm">
                    O sistema aceita CNAB 240, CNAB 400 e CSV. Para CSV, o arquivo deve conter colunas como tipo 
                    (pagar/receber), data_vencimento, descrição, valor, número_documento, fornecedor/cliente, etc.
                  </p>
                </div>
  ...
  const categories = [
    { id: 'todos', name: 'Todos', count: getAllSections(sections).length },
    { id: 'inicio', name: 'Início', count: getAllSections(sections).filter(s => s.category === 'inicio').length },
    { id: 'conceitos', name: 'Conceitos', count: getAllSections(sections).filter(s => s.category === 'conceitos').length },
    { id: 'guia', name: 'Guia Prático', count: getAllSections(sections).filter(s => s.category === 'guia').length },
    { id: 'suporte', name: 'Suporte', count: getAllSections(sections).filter(s => s.category === 'suporte').length },
  ];
  ...
  const sectionSearchText: Record<string, string> = {
    ...
    'conciliacao-bancaria': 'conciliação bancária lançamentos contábeis erp matches aprovar rejeitar exportar cnab',
  ...
  const currentSection = allSections.find(s => s.id === selectedSection);

  const renderSectionTree = (section: Section, level: number = 0) => {
    const hasSubsections = section.subsections && section.subsections.length > 0;
    const isExpanded = expandedSections.has(section.id);
    const isSelected = selectedSection === section.id;
    const isVisible = !section.subsections || filteredSections.some(s => section.subsections?.some(sub => sub.id === s.id));

    if (!isVisible && section.subsections) return null;
          ...
          <>
            ...
            {isExpanded && section.subsections && (
              <div className="mt-1 space-y-1">
                {section.subsections
                  .filter(sub => filteredSections.some(s => s.id === sub.id))
                  .map(subsection => renderSectionTree(subsection, level + 1))}
              </div>
            )}
          </>
        ) : (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="card sticky top-4">
              ...
              {/* Índice com Estrutura Hierárquica */}
              <div>
